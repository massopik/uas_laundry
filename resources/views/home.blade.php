...
<html lang="zxx">
	<head>
		...
		<link href="{{ asset('front/css/prettyPhoto.css')}}" rel="stylesheet" type="text/css">
		<!--prettyPhoto slider-->
		<!--stylesheets-->
	...
	<body>
		<div class="header-outs" id="home">
				...
				<div class="container">
					...
					<div class="row pt-md">
						<div class="col-lg-3 col-md-6 col-sm-6 profile">
							<div class="bodr-img">
								<div class="img-box">
									<img src="{{ asset('front/images/t1.jpg')}}" alt="">
						...
						<div class="col-lg-3 col-md-6 col-sm-6 profile">
							<div class="img-box">
								<img src="{{ asset('front/images/t3.jpg')}}" alt="">
								<ul class="text-center">
						...
						<div class="col-lg-3 col-md-6 col-sm-6 profile">
							<div class="img-box">
								<div class="team-list-img">
									<img src="{{ asset('front/images/t4.jpg')}}" alt="">
								</div>
								<ul class="text-center">
						...
						<div class="col-lg-3 col-md-6 col-sm-6 profile">
							<div class="img-box">
								<img src="{{ asset('front/images/t5.jpg')}}" alt="">
								<ul class="text-center">
					...
					<div class="row pt-md">
						<div class="col-lg-3 col-md-6 col-sm-6 profile">
							<div class="bodr-img">
								<div class="img-box">
									<img src="{{ asset('front/images/t6.jpg')}}" alt="">
									<ul class="text-center">
						...
						<div class="col-lg-3 col-md-6 col-sm-6 profile">
							<div class="img-box">
								<div class="team-list-img">
									<img src="{{ asset('front/images/t2.jpg')}}" alt="">
								</div>
								<ul class="text-center">
									<li><h4>Kent Kelly</h4></li>
									<li><h6>Dry Cleaning</h6></li>
			...
			<script src="{{ asset('front/js/jquery-1.7.2.js')}}"></script>
			<script src="{{ asset('front/js/jquery.quicksand.js')}}"></script>
