        ...
        <div class="topbar-left">
          <div class="text-left">
            <a href="index.html" class="logo">
              <img src="{{ asset('logo.jpg') }}" style="height:45px;margin-left:20px;">
            </a>
          </div>
        </div>
            ...
            <div class="">
              ...
              <ul class="nav navbar-nav navbar-right pull-right">
                <li class="dropdown hidden-xs">
                  ...
                  <li class="dropdown">
                    <a href="" class="dropdown-toggle profile" data-toggle="dropdown" aria-expanded="true"><img src="{{ asset('logo.jpg')}}" alt="user-img" class="img-circle"> </a>
