    ...
    <div class="wrapper-page">
      <div class="panel panel-color panel-primary panel-pages">
        ...
        <div class="panel-body">
          <form class="form-horizontal m-t-20" action="<?php echo e(url(action('LoginController@postLogin'))); ?>" method="post">
            ...
            <div class="form-group m-t-40">
              <div class="col-xs-12">
                ...
                <a href="<?php echo e(url('/register')); ?>" class="btn btn-success">Register</a>
